  ...
  <div>
    <div>
      <div class="handle-box">
        ...
        <el-button type="primary" icon="mdi:magnify" @click="search()">搜索</el-button>
      ...
      <el-table :data="resourcePaths" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column label="操作" width="180" align="center">
          <template slot-scope="scope">
            <el-button type="text" icon="mdi:pencil" @click="handleEdit(scope.row)">编辑</el-button>
            <el-button type="text" icon="mdi:delete" style="color: var(--orangeRed)"
    ...
    <el-dialog title="图片"
      ...
      <div>
        ...
        <uploadPicture ref="coverUpload" :isAdmin="true" :prefix="resourcePath.type + 'Cover'" @addPicture="addPicture" :maxSize="2"
                       :maxNumber="1" :storeType="storeType"></uploadPicture>
      </div>
    </el-dialog>
    ...
    <el-dialog title="文件"
      ...
      <div>
        ...
        <uploadPicture ref="fileUpload" :isAdmin="true" :prefix="resourcePath.type + 'Url'" @addPicture="addFile" :maxSize="10"
                       :maxNumber="1" :listType="'text'" :accept="'image/*, video/*, audio/*'" :storeType="storeType"></uploadPicture>
      </div>
    </el-dialog>
  ...
  export default {
    ...
    data() {
      return {
        ...
        storeType: localStorage.getItem("defaultStoreType") || "local",
        resourcePath: {
          title: "",
          classify: "",
          introduction: "",
