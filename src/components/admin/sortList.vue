  ...
  <div>
    ...
    <el-table :data="sortInfo" border class="table" header-cell-class-name="table-header">
      ...
      <el-table-column label="操作" width="380" align="center">
        <template slot-scope="scope">
          <el-button type="text" icon="mdi:pencil" @click="editSort(scope.row)">
            编辑分类
          </el-button>
          <el-button type="text" icon="mdi:pencil" @click="sayLabel(scope.row)">
            查看标签
          </el-button>
          <el-button type="text" icon="mdi:pencil" @click="insertLabel(scope.row)">
            新增标签
          </el-button>
    ...
    <el-table v-if="!$common.isEmpty(sort)" :data="sort.labels" border class="table"
      ...
      <el-table-column label="操作" width="320" align="center">
        <template slot-scope="scope">
          <el-button type="text" icon="mdi:pencil" @click="editLabel(scope.row)">
            编辑标签
          </el-button>
          <el-button type="text" icon="mdi:delete" style="color: var(--orangeRed)"
