    ...
    <div class="myBetween" style="margin-bottom: 10px">
      <div style="display: flex">
        <div :class="{'emoji-active':showEmoji}"
          ...
          <iconify-icon icon="mdi:emoticon-happy" class="myEmoji"></iconify-icon>
        </div>
        <div @click="openPicture()">
          <iconify-icon icon="mdi:image" class="myPicture"></iconify-icon>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        showPicture: false,
        picture: {
          name: !this.$common.isEmpty(this.$store.state.currentUser)
