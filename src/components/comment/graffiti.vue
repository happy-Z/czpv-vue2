  ...
  export default {
    ...
    data() {
      return {
        ...
        brushSize: [{
          className: "small mdi mdi-pencil",
          lineWidth: 5,
        }, {
          className: "middle mdi mdi-pencil",
          lineWidth: 10,
        }, {
          className: "big mdi mdi-pencil",
          lineWidth: 15,
        }]
      };
    },
      ...
      controls() {
        return [{
          ...
          className: this.preDrawAry.length
            ? "active mdi mdi-arrow-left"
            : "ban mdi mdi-arrow-left",
        }, {
          title: "下一步",
          action: "next",
          className: this.nextDrawAry.length
            ? "active mdi mdi-arrow-right"
            : "ban mdi mdi-arrow-right",
        }, {
          title: "清除",
          action: "clear",
          className:
            this.preDrawAry.length || this.nextDrawAry.length
              ? "active mdi mdi-refresh"
              : "ban mdi mdi-refresh",
        }];
      }
    },
