<template>
  <div>
    ...
    <div class="signature-wall myCenter my-animation-hideToShow">
      ...
      <iconify-icon icon="mdi:chevron-down" class="arrow-down-icon" @click="navigation('.page-container-wrap')"></iconify-icon>
    </div>
    <!-- 首页内容 -->
      ...
      <div class="page-container">
        ...
        <div class="recent-posts">
          <div class="announcement background-opacity">
            <iconify-icon icon="mdi:volume-high" class="announcement-icon"></iconify-icon>
            <div>
  ...
  export default {
    ...
    methods: {
      ...
      async selectArticle(articleSearch) {
        const searchPayload = this.normalizeSearchPayload(articleSearch);
      ...
      normalizeSearchPayload(payload) {
        ...
        if (this.$common.isEmpty(payload)) {
          return {
            keyword: "",
            queryText: "",
            mode: "smart",
        ...
        const keyword = (payload.keyword || payload.queryText || "").trim();
        return {
          keyword: keyword,
          queryText: (payload.queryText || keyword).trim(),
          mode: payload.mode || "smart",
          field: payload.field || "all"
        };
      },
      pageArticles() {
...
<style scoped>
  ...
  .announcement-icon {
    ...
    animation: announcement-bounce 1.2s cubic-bezier(0.22, 1, 0.36, 1) infinite;
  }
