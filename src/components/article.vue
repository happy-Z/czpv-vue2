      ...
      <div style="background: var(--background);">
        <div class="article-container my-animation-slide-bottom">
          ...
          <div class="myCenter" id="article-like" @click="subscribeLabel()">
            <iconify-icon icon="mdi:thumb-up" class="article-like-icon" :class="{'article-like': subscribe}"></iconify-icon>
          </div>
      ...
      highlight() {
        ...
        $("pre code").each(function (i, block) {
          ...
          $(block).after(
            ...
            i +
            '"><iconify-icon icon="mdi:clipboard-text" aria-hidden="true"></iconify-icon></a>'
          );
